...
public class App extends Application implements Runnable {
	...
	/**
	 * £¹czenie siê aplikakacji z logik¹.
	 */
...
/**
 * Zmiana sceny aplikacji an planszê do gry.	
 * @param isServer
 */
	...
	/**
	 *Funkcja tworzy widok, w którym u¿ytkownik decydujê czy chce stworzyæ
	 * serwer na swoim komputerze czy po³¹czyæ siê ju¿ z istniej¹cym. 
	 */
	...
	/**
	 * Funkcja, która tworzy i umieszcza w interfejsie widok logowania siê 
	 * do aplikacji.
	 */
	...
	/**
	 * Start po³¹czenia TCP.
	 * @param boolean isServer- okreœla czy aplikacja jest serwerem czy klientem  
	 */
	...
	/**
	 * Funkcja tworzy i wrzuca do interfejsu widok koñca gry.
	 */
