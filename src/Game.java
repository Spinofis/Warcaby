 ...
 * 
 * @author Bartek
 *Klasa, która odpowiada za logikê warcab.
 */
 ...
 */
	...
	/**
	 * Rozpoznanie jaki ruch pionkiem wykona³ u¿ytkownik na podstawie starych i nowych koordynatów pionka.
	 * Metoda rozpoznaje ruchy pionka tylko jeœli nie jest damk¹.
	...
	/**
	 * Funkcja, która rozpoznaje, czy by³o bicie i w któr¹ stronê, np. Prawo i góra to KILL1.
     *@param int oldX stary koordynat X planszy 
	 * @param int oldY stary koordynat Y planszy
	 * @param int newX nowy koordynat X planszy
	 * @param int newY nowy koordynat Y planszy 
	...
	/**
	 * Metoda, która sprawdza czy damka wykona³a poprawny ruch.
	 * @param int oldX stary koordynat X planszy 
	 * @param int oldY stary koordynat Y planszy
	 * @param int newX nowy koordynat X planszy
	 * @param int newY nowy koordynat Y planszy 
	...
	/**
	 * Metoda zmienia kolejnoœæ wykonywania ruchu.
	 */
    ...
    /**
     * Metoda zmniejsza liczbê pionków. 
